...
class Warehouse(gym.Env):
    ...
    def _use_image_obs(self, image_observation_layers, directional=True):
        ...
        self.observation_space = spaces.Tuple(tuple([spaces.Box(min_obs, max_obs, dtype=np.float32)] * self.n_agents))
    ...
    def _use_slow_obs(self):
        ...
        if self.normalised_coordinates:
            ...
            location_space = spaces.MultiDiscrete([self.grid_size[1], self.grid_size[0]])
