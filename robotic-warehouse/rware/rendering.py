            ...
            batch.add(
                ...
                (
                    ...
                    (
                        ...
                        + self.grid_size // 2
                        + 1
                        + (radius if person.dir.value == Direction.RIGHT.value else 0)  # DIR X
                        + (-radius if person.dir.value == Direction.LEFT.value else 0),  # DIR X
                        (self.grid_size + 1) * row
                        + self.grid_size // 2
                        + 1
                        + (radius if person.dir.value == Direction.UP.value else 0)  # DIR Y
                        + (-radius if person.dir.value == Direction.DOWN.value else 0),  # DIR Y
                    ),
                ),
                ("c3B", (*_AGENT_DIR_COLOR, *_AGENT_DIR_COLOR)),
            )
