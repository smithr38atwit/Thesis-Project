...
def config():
    ...
    num_processes = 10  # number of parallel environments
    num_steps = 500  # number of steps per batch
    ...
    def update(
        ...
        for oid in other_agent_ids:
            ...
            other_values, logp, _, _ = self.model.evaluate_actions(
                ...
                storages[oid].recurrent_hidden_states[0].view(-1, self.model.recurrent_hidden_state_size),
